...
#define states_1 (*((volatile unsigned long *)0x20000CCC))
//static int states_1=2;
#define states_2 (*((volatile unsigned long *)0x200003CC))
#define mode_flag (*((volatile bool *)0x2000030C))
/////////////////////////////1///////////////////////////////
#define switch_flag (*((volatile bool *)0x2000034C))
/////////////////////////////1///////////////////////////////
void states (void);
